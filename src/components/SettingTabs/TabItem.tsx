...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    ...
    >
      <span className="whitespace-nowrap rounded group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4 dark:group-focus-visible:ring-violet-500 dark:group-focus-visible:ring-offset-0">
        {title}
      </span>
